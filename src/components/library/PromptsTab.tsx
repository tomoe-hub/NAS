...
/** プロンプトライブラリ（localStorage保存）。/library の「プロンプト」タブ */
    ...
    <div>
      ...
      <div className="flex items-center justify-between mb-6">
        <p className="text-sm" style={{ color: 'var(--text-muted)' }}>
          よく使うプロンプトを保存して、一次執筆でいつでも呼び出せます（この端末のブラウザに保存されます）
        </p>
        {!isEditorOpen && (
        ...
        >
          ...
          >
            <div className="flex items-start justify-between mb-4">
              ...
              <button onClick={() => setDeleteTarget(null)} className="p-1.5 rounded-[8px] transition-colors hover:bg-[rgba(20,44,92,0.06)]" style={{ color: 'var(--text-muted)' }}>
                <X size={16} />
              </button>
            </div>
            <div className="flex justify-end gap-3 pt-2">
